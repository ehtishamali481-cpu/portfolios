...
const ExperienceSection = ({ experiences: propExperiences }: ExperienceProps) => {
  const { experiences: contextExperiences, experiencesLoading } = usePortfolio();
    ...
    >
      <div className="mx-auto max-w-3xl">
        ...
        <div className="relative mt-16 border-l border-zinc-200 pl-6 dark:border-zinc-800">
          {experiencesLoading && expList.length === 0 ? (
