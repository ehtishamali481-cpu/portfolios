...
async function GET() {
    try {
        ...
        const projects = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Project"].find().sort({
            createdAt: -1
        });
...
async function POST(req) {
    try {
        ...
        const techArray = Array.isArray(tech) ? tech.map((t)=>String(t).trim()).filter(Boolean) : typeof tech === 'string' ? tech.split(',').map((t)=>t.trim()).filter(Boolean) : [];
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectMongoDB"])();
        const newProject = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Project"].create({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0vpy-uv._.js.map